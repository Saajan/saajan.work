            ...
            <div className="w-2/3 p-4">
                ...
                <div className="flex items-center justify-center">
                    <button className="icon-button twitter">
                        <a className="flex justify-center" href="https://twitter.com/" target="_blank" rel="noreferrer">
                            <AiOutlineTwitter />
                        </a>
                    </button>
                    <button className="icon-button facebook">
                        <a className="flex justify-center" href="https://www.facebook.com/thebeatlog/" target="_blank" rel="noreferrer">
                            <AiOutlineFacebook />
                        </a>
                    </button>
                    <button className="icon-button instagram">
                        <a className="flex justify-center" href="https://www.instagram.com/thebeatlog/" target="_blank" rel="noreferrer">
                            <AiOutlineInstagram />
                        </a>
                    </button>
                </div>
